...
- Identificar práticas ruins em um código de uma API Java.
- Separar corretamente as responsabilidades do projeto.
- Utilizar técnicas de refatoração de código.
- Aplicar padrões de projeto no código do projeto.
